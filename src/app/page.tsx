...
import { fetchSkillsData } from '@/backend/fetchSkillData';
...
export default async function Home() {
  ...
  return (
    <div>
      {/*<Navbar /> */}
      <div className="flex flex-col items-center justify-start min-h-screen py-0.5 mt-10">
        ...
        <HomeClient expData={expData} skillsData={skillsData}/>
      </div>
    </div>
  );
} 